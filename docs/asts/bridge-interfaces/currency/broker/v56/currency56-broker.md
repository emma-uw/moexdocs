...
format: md
title: Currency56 — Currency market interface, v.56
sidebar_label: Currency56 — Currency market interface, v.56
---

## Information objects of market 'Currency56' - 'Currency market interface, v.56'
...
| O | CO | Combined offer |
| V | ST | Specialized trade |
| v | SB | Specialized trade on the basis |
| o | CNO | Combined negotiated offer |
| U | SNT | Specialized negotiated trade |
| u | SNB | Spcialized negotiated trade on the basis |
...
---
The document is created with ASTSExplorer.exe 05.12.2025 12:00:37
