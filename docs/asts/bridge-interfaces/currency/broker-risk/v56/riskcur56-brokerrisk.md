...
format: md
title: RiskCur56 — Currency market clearing interface, v.56
sidebar_label: RiskCur56 — Currency market clearing interface, v.56
---

## Information objects of market 'RiskCur56' - 'Currency market clearing interface, v.56'
...
#### TSpecSettleMode - Special mode of settlement (size: 1, type: ekCheck)

| Constant | Value | Description |
| --- | --- | --- |
| N |  | No |
| Y | Yes | Yes |
| P | External settlement | External settlement |
| R | Roll | Special mode of settlement with position roll |
...
| SPECSETTLEMODE | Special mode of settlement | [TSpecSettleMode](#eTSpecSettleMode) | 1 |  |
...
---
The document is created with ASTSExplorer.exe 05.12.2025 12:09:11
