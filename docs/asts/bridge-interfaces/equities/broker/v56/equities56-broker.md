...
format: md
title: Equities56 — Bonds and Equities market interface, v.56
sidebar_label: Equities56 — Bonds and Equities market interface, v.56
---

## Information objects of market 'Equities56' - 'Bonds and Equities market interface, v.56'
...
#### TCSpecial - Тип РК (size: 1, type: ekCombo)
...
| K |  | Treasury |
| O |  | Correspondent |
| P |  | Unrestricted frgn nom. holder |
| Q |  | Restricted frgn nom. holder |
| R |  | Brokerage |
| T |  | Custodian |
| V | 2, 3 lev. clients | Clients of levels 2 and 3 |
| Z |  | Emission |
...
#### TIndexIndicator - Service type (size: 1, type: ekGroup)
...
| W | С | Weighted average price limit order |
...
#### TRMCheckFlags - Check flags (size: 1, type: ekCombo)

| Constant | Value | Description |
| --- | --- | --- |
|  |  | All checks |
| U | U | Without single limit check |
| C | C | Unconditional transfer |
...
## Interface 'Broker' - 'Interface for brokerage systems, v.56'
...
| FACEAMOUNT | FaceAmount | FIXED | 16.2 | Value of trade by face value, expressed in the face unit currency |
...
| TRADESESSIONDATE | Trade session date | DATE | 8 | Trading session date of registration of trade |
| TRADEDATE | Trade date | DATE | 8 | Trade calendar date |
| ZSPREAD | Z-spread | FIXED | 9.2 | Z-spread calculated by the transaction price |
...
| CSPECIAL | Счет типа С | [TCSpecial](#eTCSpecial) | 1 | Признак специального РК типа "C" |
| WEEKENDSESSION | Availability in additional weekend session | [TYesNo](#eTYesNo) | 1 | Флаг допуска РК до торгов в дополнительной сессии выходного дня |
...
#### BONDSUBTYPE - Подвид облигации (not updateable)

Классификатор подвида облигаций
...
#### BONDTYPE - Вид облигации (not updateable)

Классификатор вида облигаций
...
| CATEGORY | Clientcodes Category | CHAR | 20 |  |
...
| CALLOPTIONYIELD | Yield to call-option date | FIXED | 9.2 | Yield to call-option date |
| ZSPREAD | Z-spread | FIXED | 9.2 | Z-spread on the quote price |
| CALLOPTIONZSPREAD | Z-спред к колл-опциону | FIXED | 9.2 | Z-spread to the call option's expiration date based on the quote price |
...
| WEEKENDSESSION | Availability in additional weekend session | [TYesNo](#eTYesNo) | 1 | Флаг допуска фирмы до торгов в дополнительной сессии выходного дня |
...
| ENTRYDATE | Registration date | DATE | 8 | Order registration calendar date |
...
| OPENREPOEVERGREENTERM | EverGreen term | INTEGER | 4 | Period until settlement of the second part of the REPO with open date |
| TRADESESSIONDATE | Trading session date | DATE | 8 | Trading session date of registration of order |
| MATCHEDVALUE | Completed value | FIXED | 16.2 | Total value of all trades for this order |
| PERCENTPERIOD | Interest payment period | INTEGER | 4 |  |
| ZSPREAD | Z-spread | FIXED | 9.2 | Z-spread of the bid price |
...
| IMPLIEDFLAG | Implied value | CHAR | 1 |  |


#### SECDERIV - Derivatives (not updateable)
...
| Output field | Description | Type | Size | Remarks |
| --- | --- | --- | --- | --- |
| SECINDEXFLAG | Security or index flag | [TIndexIndicator](#eTIndexIndicator) | 1 |  |
| SECBOARD | Derivative board ID | CHAR | 4 | Derivative instrument board ID |
| SECCODE[*](#refs) | Derivative security ID | CHAR | 12 | Dervative instrument security ID |
| DERIVTYPE | Derivative type | CHAR | 1 |  |
| LSECBOARD | Board, add. restrict. | CHAR | 4 | Board ID for the security in additional restriction |
| LSECCODE[*](#refs) | Underlying security ID | CHAR | 12 | Underlying instrument security ID |
| QUANTITY | Lots | INTEGER | 16 | Quantity, expressed in lots |
| DORDER | Ordinal number | INTEGER | 1 | Derivative instrument trade ordinal number |
| SETTLECODE | Settlement code | CHAR | 12 | Settlement code for a trade with an underlying intrument |
| DREVERSE | Reverse | [TYesNo](#eTYesNo) | 1 | Reverse direction of a trade with an underlying instrument |
...
| MATDATE | Maturity date | DATE | 8 |  |
| COUPONVALUE | Coupon value | FIXED | 13.2 | Value of the due coupon payment, expressed in the face unit currency |
...
| CALLOPTIONDATE | Call-option date | DATE | 8 | Call-option date |
| ZSPREADATPREVWAPRICE | Z-spread, based on the last day WA price | FIXED | 9.2 | Z-spread based on the previous trading day's evaluation |
| BONDTYPE | Вид облигации | INTEGER | 2 | Классификатор вида облигаций |
| BONDSUBTYPE | Подвид облигации | INTEGER | 2 | Классификатор подвида облигаций |
...
| CALLOPTIONYIELD | Yield at WAPrice to call-option date | FIXED | 9.2 | Yield at WAPrice to call-option date |
| CALLOPTIONDURATION | Duration to call-option date | FIXED | 7.2 | Duration to the call option date, based on the Yield at WAPrice or Yield at Last Market Price |
| WEEKENDSESSION | Availability in additional weekend session | [TYesNo](#eTYesNo) | 1 | Флаг допуска бумаги до торгов в дополнительной сессии выходного дня |
| MAINSESSIONWAPRICE | MWA | FLOAT | 17 | Weighted-average price of the main session |
| ZSPREAD | Z-spread for the last | FIXED | 9.2 | Z-spread at the price of the last trade |
| ZSPREADATWAPRICE | Z-spread, based on the WA price | FIXED | 9.2 | Z-spread based on the weighted average price |
| CALLOPTIONZSPREAD | Z-spread at WAPrice to call-option date | FIXED | 9.2 | Z-spread at WAPrice to call-option date |
...
| TRADESESSIONDATE | Trading session date | DATE | 8 | Trading session date |
...
| ENABLEGTTORDER | GTT orders | [TYesNo](#eTYesNo) | 1 | Will the active orders of this trdacc, which remained unfulfilled in the main session, move to the evening session |
...
| ISDEFAULT | Default underwriter | [TYesNo](#eTYesNo) | 1 |  |
...
| TRADESESSIONDATE | Trade session date | DATE | 8 | Trading session date of registration of trade |
| PERCENTPERIOD | Interest payment period | INTEGER | 4 |  |
| PLANNEDINTEREST | Planned interest sum | FIXED | 16.2 | Sum of planned interim interest payments |
...
| RMCHECKFLAGS | Check flags | [TRMCheckFlags](#eTRMCheckFlags) | 1 |  |
...
---
The document is created with ASTSExplorer.exe 05.12.2025 12:05:21
