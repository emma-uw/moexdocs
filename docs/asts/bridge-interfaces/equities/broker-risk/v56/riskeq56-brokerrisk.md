...
format: md
title: RiskEq56 — Equity market clearing interface, v.56
sidebar_label: RiskEq56 — Equity market clearing interface, v.56
---

## Information objects of market 'RiskEq56' - 'Equity market clearing interface, v.56'
...
## Interface 'BrokerRisk' - 'Clearing interface for brokerage systems, v.56'
...
| GCPOOLCOLLATERALPERCENT | Partial collateral for GC pools | FIXED | 6.3 | The value as a percentage of funds in GC pools, which is accepted as collateral |
...
| TRADEDATE | Date | DATE | 8 | Trade calendar date |
...
| **GCPOOLID** | **Pool ID** | **CHAR** | **12** |  |
| **ASSET** | **Asset** | **CHAR** | **12** |  |
| PAIDCOLLATERAL | Paid collateral | [TYesNo](#eTYesNo) | 1 |  |
...
| CLEARINGPROC | Termination of obligations | [TYesNo](#eTYesNo) | 1 |  |
| RMPOSTYPE | Open position type | CHAR | 1 | Open position type for combination of asset and settlement date |
...
---
The document is created with ASTSExplorer.exe 05.12.2025 12:10:48
