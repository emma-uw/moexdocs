...
format: md
title: Aux02 — Equities trading system auxiliary functions, v.02
sidebar_label: Aux02 — Equities trading system auxiliary functions, v.02
---

## Information objects of market 'Aux02' - 'Equities trading system auxiliary functions, v.02'
...
## Interface 'Broker' - 'Users interface, auxiliary functions, v.02'
...
---
The document is created with ASTSExplorer.exe 11.04.2023 14:58:18
